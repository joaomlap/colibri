...
export class EventBus {
  ...
  // ) {}
  // publish<T extends IEvent>(aggregateId: string, events: T[]) {
  //   return this.publisher.publish(aggregateId, events);
  // }
  // bind<T extends IEvent>(event: T, handler: IEventHandler) {
